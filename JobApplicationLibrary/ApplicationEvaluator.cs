...
namespace JobApplicationLibrary
{
    public class ApplicationEvaluator
    {
        ...
        public ApplicationResult Evaluate(JobApplication form)
        {
            ...
            validator.ValidationMode = form.Applicant.Age > 50 ? ValidationMode.Detailed : ValidationMode.Quick;

            if (validator.CountryDataProvider.CountryData.Country != "TURKEY")
